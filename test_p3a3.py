...
for n_ctx in n_ctx_list:
    dataset = AR(num_examples, tokenizer, 1, M=16, n_ctx=n_ctx, seed=seed, train_split=0.01)
...
plt.savefig(os.path.join(root, f'AR_Acc_All_1_M16.png'))
