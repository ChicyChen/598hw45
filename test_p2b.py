...
model_names = ["T-RoPE_M4", "T-RoPE_M8", "T-RoPE_M16"]
models = []

mamba_model4 = RoPENet(len(tokenizer), embed_dim, max_len=n_ctx*4, attn_layers=attn_layers).to(device)
...
mamba_model8 = RoPENet(len(tokenizer), embed_dim, max_len=n_ctx*4, attn_layers=attn_layers).to(device)
...
mamba_model16 = RoPENet(len(tokenizer), embed_dim, max_len=n_ctx*4, attn_layers=attn_layers).to(device)
