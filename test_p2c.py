...
model_names = ["Hybrid-A_M4", "Hybrid-A_M8", "Hybrid-A_M16"]
models = []

mamba_model4 = HybridA(len(tokenizer), embed_dim, max_len=n_ctx*4, attn_layers=attn_layers).to(device)
...
mamba_model8 = HybridA(len(tokenizer), embed_dim, max_len=n_ctx*4, attn_layers=attn_layers).to(device)
...
mamba_model16 = HybridA(len(tokenizer), embed_dim, max_len=n_ctx*4, attn_layers=attn_layers).to(device)
